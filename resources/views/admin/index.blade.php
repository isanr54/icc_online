      ...
      <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right animated zoomIn">
                                <ul class="dropdown-user">
                                    <li><a href="profil.html"><i class="ti-user"></i> Profile</a></li>
        ...
        <div class="left-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li> <a href="/admin" aria-expanded="false"><i class="fa fa-tachometer"></i>Dashboard</a>
                        </li>
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body browser">
                                <p class="f-w-600">Pulsa <span class="pull-right">85%</span></p>
                                <div class="progress ">
                                ...
                                <p class="m-t-30 f-w-600">Paket Data<span class="pull-right">90%</span></p>
                                <div class="progress">
                                ...
                                <p class="m-t-30 f-w-600">Vocher Game<span class="pull-right">65%</span></p>
                                <div class="progress">
                                ...
                                <p class="m-t-30 f-w-600">PLN<span class="pull-right">65%</span></p>
                                <div class="progress">
								...
								<p class="m-t-30 f-w-600">PDAM<span class="pull-right">65%</span></p>
                                <div class="progress m-b-30">
                                    <div role="progressbar" style="width: 65%; height:8px;" class="progress-bar bg-success wow animated progress-animated"> <span class="sr-only">60% Complete</span> </div>
                                </div>
                                <p class="m-t-30 f-w-600">BPJS<span class="pull-right">65%</span></p>
                                <div class="progress m-b-30">
                                    <div role="progressbar" style="width: 65%; height:8px;" class="progress-bar bg-success wow animated progress-animated"> <span class="sr-only">40% Complete</span> </div>
                                </div>
                                <p class="m-t-30 f-w-600">Multifinance<span class="pull-right">65%</span></p>
                                <div class="progress m-b-30">
                                    <div role="progressbar" style="width: 65%; height:8px;" class="progress-bar bg-success wow animated progress-animated"> <span class="sr-only">35% Complete</span> </div>
                                </div>
                                <p class="m-t-30 f-w-600">Topup<span class="pull-right">65%</span></p>
                                <div class="progress m-b-30">
                                    <div role="progressbar" style="width: 65%; height:8px;" class="progress-bar bg-success wow animated progress-animated"> <span class="sr-only">75% Complete</span> </div>
                                </div>
                            </div>
                        </div>
                    </div>
