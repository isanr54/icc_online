...
<body class="fix-header fix-sidebar">
    <!-- Preloader - style you can find in spinners.css -->
        ...
        <div class="header">
            ...
            <a class="navbar-brand" href="#">ICC ONLINE</a>
      <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <div class="left-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li> <a href="admin.html" aria-expanded="false"><i class="fa fa-tachometer"></i><span>Dashboard</span></a>
                        </li>
                        <li><a href="/datauser"><i class="fa fa-users"></i>Data Users</a></li>
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-folder"></i><span class="hide-menu">Data Transaksi</span></a>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Data Transaksi Admin</h4>
