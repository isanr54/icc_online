  ...
  <body>
    ...
    <div class="caption center-align">
      <h3>Beli Pulsa Murah dan Cepat</h3>
    </div>
    ...
    <div class="card ">
        <div class="card-tabs ">
          <ul class="tabs tabs-fixed-width">
            <li class="tab"><a class="active" href="index.php">Pulsa</a></li>
            <li class="tab"><a href="index_game.php">Voucher Game</a></li>
          </ul>
        </div>
          ...
          <div id="pulsa" class="active" style="display: block;">
            ...
            <form action="page/konfirmasi.php" method="post">
              <div class="input-field col s12">
                <input id="pulsa" name="no_hp" type="text" class="validate" placeholder="Masukan nomor yang akan diisi">
              ...
              <div class="input-field col s12">
                  <select id="provider" name="provider" onchange="fetch_select(this.value);">
                    ...
                    <?php
                      $select=$koneksi->query("SELECT * FROM kode_pulsa GROUP BY nama_produk");
