            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Data Transaksi Users</h4>
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr> 
                                            <td><?=$i?></td>
                                            <td><?=$tampil['email_user']?></td>
                                            <td><?=$tampil['kode_produk']?></td>
                                            <td><?=$tampil['nomor_transaksi']?></td>
                                            <td>Rp.<?=number_format($tampil['harga'],0,'.','.')?></td>
                                            <td>Sukses</td>
                                            <td><a href="action/hapus_trx_user.php?id=<?=$tampil['id_transaksi']?>" class="btn btn-danger btn-sm">Hapus</a></td>
                                            </tr>
                                            <?php
                                            $i++;
                                            }
