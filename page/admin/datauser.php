                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <?php
                                            ...
                                            <td><?=$tampil['no_hp']?></td>
                                            <td><?=$tampil['saldo']?></td>
                                            <td><a href="action/edit_user.php?id=<?=$tampil['id_user']?>" class="btn btn-warning btn-sm">Edit</a>|<a href="action/delete_user.php?id=<?=$tampil['id']?>" class="btn btn-danger btn-sm">Hapus</a></td>
                                            </tr>
                                            <?php
                                            $i++;
                                            }
